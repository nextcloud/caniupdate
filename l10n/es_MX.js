OC.L10N.register(
    ...
    "Missing updates" : "Actualizaciones faltantes",
    "View in store" : "Ver en tienda",
    "Available updates" : "Actualizaciones disponibles",
    "Checking …" : "Verificando ...",
    "You are already on the latest major version." : "Ya te encuentras en la versión mayor más reciente. ",
    "Appstore is disabled in your configuration." : "La appstore está deshabilitada en tu configuración.",
    "Maybe …" : "Tal vez ...",
    "Yes!" : "¡Sí!",
    "No!" : "¡No!",
    ...
    "_%n app has no version for Nextcloud {version} available_::_%n apps have no version for Nextcloud {version} available_" : ["La aplicación %nno tiene una versión para Nextcloud {version} disponible","Las aplicaciones %n no tienen una versión para Nextcloud {version} disponible"]
},
